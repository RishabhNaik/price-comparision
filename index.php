...
<body>
    ...
    <form action="#" class="form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
        <input type="text" id="searchInput" class="form-control" placeholder="Enter your product">
    ...
    <script>
        const dataset = [
            { id: 1, name: 'Item 1', description: 'Description for Item 1', price: '$50' },
            { id: 2, name: 'Item 2', description: 'Description for Item 2' ,price: '$89'},
            { id: 3, name: 'Item 3', description: 'Description for Item 3',price:'$56' },
            // ...
        ];
        ...
        function searchData(event) {
            ...
            const matchingData = dataset.filter(item => item.name.toLowerCase().includes(searchTerm));
  ...
  <main id="main">
    ...
    <section id="featured-services" class="featured-services">
            ...
            <div>
                ...
                <p class="description">Let's compare</p>
                <a href="service-details.html" class="readmore stretched-link"><span>Learn More</span><i class="bi bi-arrow-right"></i></a>
            </div>
        </div>

        <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up">
            <div class="icon flex-shrink-0"><img src="assets/img/sites/flipkart.png" alt="Flipkart Logo"></div>
            <div>
                <h4 class="title">Flipkart</h4>
                <p class="description">Let's compare</p>
                <a href="service-details.html" class="readmore stretched-link"><span>Learn More</span><i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
